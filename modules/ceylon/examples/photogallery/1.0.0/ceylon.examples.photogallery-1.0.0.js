        ...
        $$pageModel.photos=$$$cl1.Comprehension(function(){
            ...
            return function(){
                if(photo$84!==$$$cl1.getFinished()){
                    ...
                    var tmpvar$86=Photo(photo$84$85.title,photo$84$85.caption,dir$82.plus($$$cl1.String("/",1)).plus(photo$84$85.src),dir$82.plus($$$cl1.String("/",1)).plus(photo$84$85.thumb),photo$84$85.height,photo$84$85.width,photo$84$85.alt);
                    next$photo$84();
                    return tmpvar$86;
                }
                return $$$cl1.getFinished();

...
var $$$cjl4=require('ceylon/js/language/1.8.0/ceylon.js.language-1.8.0');
$$$cl1.$addmod$($$$cjl4,'ceylon.js.language/1.8.0');
function Gallery($$gallery){
    ...
    function handlebarHelpers$11(){
        ...
        (typeof Handlebars==='undefined'||Handlebars===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: Handlebars")),'86:3-86:12','gallery.ceylon'):Handlebars).registerHelper(/*NULL PARAM!*/$$$cl1.String("gt",2).valueOf()/*NULL PARAM!*/,$$$cl1.$JsCallable(function (int1$42,int2$43,funcs$44){
            $$$cl1.print($$$cl1.String("comparing if ",13).plus(int1$42.string).plus($$$cl1.String(" is greater then ",17)).plus(int2$43.string));
            if(int1$42.compare(int2$43).equals($$$cl1.getLarger())){
                return (tmpvar$45=funcs$44.fn(/*NULL PARAM!*/(typeof this==='undefined'||this===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: this")),'89:21-89:24','gallery.ceylon'):this)),$$$cl1.isOfType(tmpvar$45,{t:$$$cl1.Anything})?tmpvar$45:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'89:12-89:27','gallery.ceylon'));
            }else {
                return (tmpvar$46=funcs$44.inverse(/*NULL PARAM!*/(typeof this==='undefined'||this===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: this")),'91:26-91:29','gallery.ceylon'):this)),$$$cl1.isOfType(tmpvar$46,{t:$$$cl1.Anything})?tmpvar$46:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'91:12-91:32','gallery.ceylon'));
            }
        },[{$nm:'int1',$mt:'prm',$t:{t:$$$cl1.Integer},$an:function(){return[];}},{$nm:'int2',$mt:'prm',$t:{t:$$$cl1.Integer},$an:function(){return[];}},{$nm:'funcs',$mt:'prm',$t:{t:$$$cl1.Anything},$an:function(){return[];}}],{Arguments:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Empty},First:{t:$$$cl1.Anything},Element:{t:$$$cl1.Anything}}},First:{t:$$$cl1.Integer},Element:{t:$$$cl1.Anything}}},First:{t:$$$cl1.Integer},Element:{t:$$$cl1.Anything}}},Return:{t:$$$cl1.Anything}}));
        /*End dynamic block*/
...
function GalleryModel(controller, dir, $$galleryModel){
    ...
    function loadJSON(){
        ...
        $$$cjj3.jQueryGetJSON($$galleryModel.dir.plus($$$cl1.String("/images.json",12))).done(/*NULL PARAM!*/$$$cl1.$JsCallable($$galleryModel.parseCategories,[{$nm:'categoriesJSON',$mt:'prm',$t:{t:$$$cl1.Sequential,a:{Element:{t:CategoryJSON}}},$an:function(){return[];}},{$nm:'status',$mt:'prm',$t:{t:$$$cl1.String},$an:function(){return[];}},{$nm:'jqXHR',$mt:'prm',$t:{t:$$$cl1.Anything},$an:function(){return[];}}],{Arguments:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Empty},First:{t:$$$cl1.Anything},Element:{t:$$$cl1.Anything}}},First:{t:$$$cl1.String},Element:{t:$$$cl1.Anything}}},First:{t:$$$cl1.Sequential,a:{Element:{t:CategoryJSON}}},Element:{t:$$$cl1.Anything}}},Return:{t:$$$cl1.Anything}})).fail(/*NULL PARAM!*/$$$cl1.$JsCallable(function (){
            return (typeof alert==='undefined'||alert===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: alert")),'158:73-158:77','gallery.ceylon'):alert)(/*NULL PARAM!*/$$$cl1.String("Error could not load image file",31).valueOf());
...
function GalleryView(controller, $$galleryView){
    ...
    function display(){
        ...
        var values$78;
        /*Begin dynamic block*/
        $$$cjj3.jq($$$cl1.String("body",4)).setHtml((tmpvar$79=template$71(/*NULL PARAM!*/context$77.toJson().$native),$$$cl1.isOfType(tmpvar$79,{t:$$$cl1.String})?tmpvar$79:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'191:28-191:60','gallery.ceylon')));
        /*End dynamic block*/
    }
    ...
    function displayCategories(){
        ...
        var values$85;
        /*Begin dynamic block*/
        var tabs$86=context$84.toJson();
        $prop$getTabs$86={$$metamodel$$:function(){return{mod:$$METAMODEL$$,$t:{t:$$$cjj2.JSJSON},d:['ceylon.examples.photogallery','GalleryView','$m','displayCategories','$at','tabs']};}};
        $prop$getTabs$86.get=function(){return tabs$86};
        $$galleryView.categoryTabs=(tmpvar$87=tabsTemplate$73(/*NULL PARAM!*/tabs$86.$native),$$$cl1.isOfType(tmpvar$87,{t:$$$cl1.String})?tmpvar$87:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'206:18-206:42','gallery.ceylon'));/*End dynamic block*/
        $$galleryView.display();
    }
...
function Category(parent, $$category){
    ...
    var model;
    $$$cl1.defineAttr($$category,'model',function(){if (model===undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to read unitialized attribute «model»'));return model;},function(model$88){if(model!==undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to reassign immutable attribute «model»'));return model=model$88;},function(){return{mod:$$METAMODEL$$,$t:{t:CategoryModel},$cont:Category,$an:function(){return[$$$cl1.shared(),$$$cl1.late()];},d:['ceylon.examples.photogallery','Category','$at','model']};});
    $$category.$prop$getModel.get=function(){return model};
    var view;
    $$$cl1.defineAttr($$category,'view',function(){if (view===undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to read unitialized attribute «view»'));return view;},function(view$89){if(view!==undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to reassign immutable attribute «view»'));return view=view$89;},function(){return{mod:$$METAMODEL$$,$t:{t:CategoryView},$cont:Category,$an:function(){return[$$$cl1.shared(),$$$cl1.late()];},d:['ceylon.examples.photogallery','Category','$at','view']};});
    $$category.$prop$getView.get=function(){return view};
    var pages=$$$cl1.getEmpty();
    $$$cl1.defineAttr($$category,'pages',function(){return pages;},function(pages$90){return pages=pages$90;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Sequential,a:{Element:{t:Page}}},$cont:Category,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','Category','$at','pages']};});
    ...
    function init(name$91,photos$92,dir$93){
        $$$cl1.print($$$cl1.String("initalizing category",20));
        var model=CategoryModel($$category,name$91);
        $$$cl1.defineAttr($$category,'model',function(){if (model===undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to read unitialized attribute «model»'));return model;},function(model$94){if(model!==undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to reassign immutable attribute «model»'));return model=model$94;},function(){return{mod:$$METAMODEL$$,$t:{t:CategoryModel},$cont:Category,$an:function(){return[$$$cl1.shared(),$$$cl1.late(),$$$cl1.shared(),$$$cl1.actual()];},d:['ceylon.examples.photogallery','Category','$at','model']};});
        var view=CategoryView($$category);
        $$$cl1.defineAttr($$category,'view',function(){if (view===undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to read unitialized attribute «view»'));return view;},function(view$95){if(view!==undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to reassign immutable attribute «view»'));return view=view$95;},function(){return{mod:$$METAMODEL$$,$t:{t:CategoryView},$cont:Category,$an:function(){return[$$$cl1.shared(),$$$cl1.late(),$$$cl1.shared(),$$$cl1.actual()];},d:['ceylon.examples.photogallery','Category','$at','view']};});
        $$category.setPages(photos$92,dir$93);
        return $$category;
    }
    $$category.init=init;
    ...
    function updatePage(page$96){
        ($$category.view.page=page$96);
    ...
    function display(pageNum$97,photoNum$98){
        $$$cl1.print($$$cl1.String("display category ",17).plus($$category.model.name).plus($$$cl1.String(" page ",6)).plus(pageNum$97.string).plus($$$cl1.String(" photo ",7)).plus(photoNum$98.string));
        $$category.view.display();
        var page$99;
        if((page$99=$$category.pages.get(pageNum$97))!==null){
            $$$cl1.print($$$cl1.String("display page",12));
            $$category.view.displayPage(pageNum$97);
            page$99.display(photoNum$98);
        }else {
    ...
    function displayPhoto(photoM$100){
        var photo$101;
        if((photo$101=photoM$100)!==null){
            $$$cl1.print($$$cl1.String("display photo",13));
            $$category.view.displayPhoto(photo$101);
        }else {
    ...
    function setPages(photosJSON$102,dir$103){
        $$$cl1.print($$$cl1.String("set category pages",18));
        var end$104=(1).plus(photosJSON$102.size.divided((6)));
        $$category.pages=$$$cl1.Comprehension(function(){
            var it$105=(function(){var tmpvar$107=end$104;
            if (tmpvar$107>0){
            var tmpvar$108=(0);
            var tmpvar$109=tmpvar$108;
            for (var i=1; i<tmpvar$107; i++){tmpvar$109=tmpvar$109.successor;}
            return $$$cl1.Range(tmpvar$108,tmpvar$109,{Element:{t:$$$cl1.Integer}})
            }else return $$$cl1.getEmpty();}()).iterator();
            var i$106=$$$cl1.getFinished();
            var next$i$106=function(){return i$106=it$105.next();}
            next$i$106();
            return function(){
                if(i$106!==$$$cl1.getFinished()){
                    var i$106$110=i$106;
                    var tmpvar$111=Page($$category,$$category.model.uri.plus(i$106$110.string).plus($$$cl1.String("/",1))).init(photosJSON$102.segment(i$106$110.times((6)),(6)),dir$103);
                    next$i$106();
                    return tmpvar$111;
                }
                return $$$cl1.getFinished();
...
function CategoryView(controller, $$categoryView){
    ...
    var template$112;
    $$$cl1.defineAttr($$categoryView,'template$112',function(){return template$112;},function(template$113){return template$112=template$113;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Anything},$cont:CategoryView,$an:function(){return[$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','template']};});
    $$categoryView.$prop$getTemplate$112={$$metamodel$$:function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Anything},$cont:CategoryView,$an:function(){return[$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','template']};}};
    $$categoryView.$prop$getTemplate$112.get=function(){return template$112};
    var paginationTemplate$114;
    $$$cl1.defineAttr($$categoryView,'paginationTemplate$114',function(){return paginationTemplate$114;},function(paginationTemplate$115){return paginationTemplate$114=paginationTemplate$115;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Anything},$cont:CategoryView,$an:function(){return[$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','paginationTemplate']};});
    $$categoryView.$prop$getPaginationTemplate$114={$$metamodel$$:function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Anything},$cont:CategoryView,$an:function(){return[$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','paginationTemplate']};}};
    $$categoryView.$prop$getPaginationTemplate$114.get=function(){return paginationTemplate$114};
    var pagination=$$$cl1.String("pagination",10);
    $$$cl1.defineAttr($$categoryView,'pagination',function(){return pagination;},function(pagination$116){return pagination=pagination$116;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.String},$cont:CategoryView,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','pagination']};});
    ...
    $$$cl1.defineAttr($$categoryView,'page',function(){return page;},function(page$117){return page=page$117;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.String},$cont:CategoryView,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','page']};});
    ...
    $$$cl1.defineAttr($$categoryView,'title',function(){return title;},function(title$118){return title=title$118;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.String},$cont:CategoryView,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','title']};});
    ...
    $$$cl1.defineAttr($$categoryView,'src',function(){return src;},function(src$119){return src=src$119;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.String},$cont:CategoryView,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','src']};});
    ...
    $$$cl1.defineAttr($$categoryView,'alt',function(){return alt;},function(alt$120){return alt=alt$120;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.String},$cont:CategoryView,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','alt']};});
    ...
    $$$cl1.defineAttr($$categoryView,'caption',function(){return caption;},function(caption$121){return caption=caption$121;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.String},$cont:CategoryView,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','caption']};});
    ...
    $$$cl1.defineAttr($$categoryView,'width',function(){return width;},function(width$122){return width=width$122;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.String},$cont:CategoryView,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','width']};});
    ...
    $$$cl1.defineAttr($$categoryView,'height',function(){return height;},function(height$123){return height=height$123;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.String},$cont:CategoryView,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','CategoryView','$at','height']};});
    ...
    /*Begin dynamic block*/
    template$112=(typeof Handlebars==='undefined'||Handlebars===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: Handlebars")),'292:13-292:22','gallery.ceylon'):Handlebars).compile(/*NULL PARAM!*/$$$cjj3.jq($$$cl1.String("#category-template",18)).getHtml().$native);paginationTemplate$114=(typeof Handlebars==='undefined'||Handlebars===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: Handlebars")),'293:23-293:32','gallery.ceylon'):Handlebars).compile(/*NULL PARAM!*/$$$cjj3.jq($$$cl1.String("#category-pagination-template",29)).getHtml().$native);/*End dynamic block*/
    function display(){
        $$$cl1.print($$$cl1.String("display category",16));
        var context$124=(values$125=/*NULL PARAM!*/[$$$cl1.Entry($$$cl1.String("title",5),$$categoryView.title,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("width",5),$$categoryView.width,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("src",3),$$categoryView.src,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("alt",3),$$categoryView.alt,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("caption",7),$$categoryView.caption,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("page",4),$$categoryView.page,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("pagination",10),$$categoryView.pagination,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})].reifyCeylonType({Absent:{t:$$$cl1.Null},Element:{t:$$$cl1.Entry,a:{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}}}}),$$$cjj2.JSON(values$125));
        var values$125;
        $$$cl1.print($$$cl1.String("src: ",5).plus($$categoryView.src));
        /*Begin dynamic block*/
        $$categoryView.controller.parent.updateCategory((tmpvar$126=template$112(/*NULL PARAM!*/context$124.toJson().$native),$$$cl1.isOfType(tmpvar$126,{t:$$$cl1.String})?tmpvar$126:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'309:36-309:68','gallery.ceylon')));
        $$$cjj3.jq($$$cl1.String(".category",9)).each($$$cl1.$JsCallable(function (index$127,item$128){
            return $$$cjj3.jqThis().removeClass($$$cl1.String("active",6));
        },[{$nm:'index',$mt:'prm',$t:{t:$$$cl1.Integer},$an:function(){return[];}},{$nm:'item',$mt:'prm',$t:{t:$$$cl1.Anything},$an:function(){return[];}}],{Arguments:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Empty},First:{t:$$$cl1.Anything},Element:{t:$$$cl1.Anything}}},First:{t:$$$cl1.Integer},Element:{t:$$$cl1.Anything}}},Return:{t:$$$cjj3.JQuery}}));
    ...
    function displayPhoto(photo$129){
        var photoWidth$130;
        if((photoWidth$130=photo$129.width)!==null){
            $$categoryView.width=photoWidth$130.string;
        }
        var photoHeight$131;
        if((photoHeight$131=photo$129.height)!==null){
            $$categoryView.height=photoHeight$131.string;
        }
        $$categoryView.src=photo$129.src;
        $$categoryView.alt=photo$129.alt;
        $$categoryView.caption=photo$129.caption;
        $$categoryView.title=photo$129.title;
    ...
    function displayPage(pageNum$132){
        var pages$133=$$$cjj2.JSONArray();
        var it$134 = $$categoryView.controller.pages.iterator();
        var page$135;while ((page$135=it$134.next())!==$$$cl1.getFinished()){
            pages$133.add((values$136=/*NULL PARAM!*/[$$$cl1.Entry($$$cl1.String("uri",3),page$135.uri,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})].reifyCeylonType({Absent:{t:$$$cl1.Null},Element:{t:$$$cl1.Entry,a:{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}}}}),$$$cjj2.JSON(values$136)));
            var values$136;
        }
        var context$137=(values$138=/*NULL PARAM!*/[$$$cl1.Entry($$$cl1.String("uri",3),$$categoryView.controller.model.uri,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("page",4),pageNum$132,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.Integer}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("lastPage",8),$$categoryView.controller.pages.size.minus((1)),{Key:{t:$$$cl1.String},Item:{t:$$$cl1.Integer}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("pages",5),pages$133,{Key:{t:$$$cl1.String},Item:{t:$$$cjj2.JSONArray}})].reifyCeylonType({Absent:{t:$$$cl1.Null},Element:{ t:'u', l:[{t:$$$cl1.Entry,a:{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}}},{t:$$$cl1.Entry,a:{Key:{t:$$$cl1.String},Item:{t:$$$cl1.Integer}}},{t:$$$cl1.Entry,a:{Key:{t:$$$cl1.String},Item:{t:$$$cjj2.JSONArray}}}]}}),$$$cjj2.JSON(values$138));
        var values$138;
        /*Begin dynamic block*/
        $$$cl1.print($$$cl1.String("displaying page with properties:",32).plus(context$137.string));
        $$categoryView.pagination=(tmpvar$139=paginationTemplate$114(/*NULL PARAM!*/context$137.toJson().$native),$$$cl1.isOfType(tmpvar$139,{t:$$$cl1.String})?tmpvar$139:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'352:22-352:64','gallery.ceylon'));/*End dynamic block*/
        $$categoryView.display();
    }
...
function Page(parent, uri, $$page){
    ...
    var model;
    $$$cl1.defineAttr($$page,'model',function(){if (model===undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to read unitialized attribute «model»'));return model;},function(model$140){if(model!==undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to reassign immutable attribute «model»'));return model=model$140;},function(){return{mod:$$METAMODEL$$,$t:{t:PageModel},$cont:Page,$an:function(){return[$$$cl1.shared(),$$$cl1.late()];},d:['ceylon.examples.photogallery','Page','$at','model']};});
    $$page.$prop$getModel.get=function(){return model};
    var view;
    $$$cl1.defineAttr($$page,'view',function(){if (view===undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to read unitialized attribute «view»'));return view;},function(view$141){if(view!==undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to reassign immutable attribute «view»'));return view=view$141;},function(){return{mod:$$METAMODEL$$,$t:{t:PageView},$cont:Page,$an:function(){return[$$$cl1.shared(),$$$cl1.late()];},d:['ceylon.examples.photogallery','Page','$at','view']};});
    $$page.$prop$getView.get=function(){return view};
    function init(photos$142,dir$143){
        $$$cl1.print($$$cl1.String("initalize page: ",16).plus($$page.uri));
        var model=PageModel($$page);
        $$$cl1.defineAttr($$page,'model',function(){if (model===undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to read unitialized attribute «model»'));return model;},function(model$144){if(model!==undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to reassign immutable attribute «model»'));return model=model$144;},function(){return{mod:$$METAMODEL$$,$t:{t:PageModel},$cont:Page,$an:function(){return[$$$cl1.shared(),$$$cl1.late(),$$$cl1.shared(),$$$cl1.actual()];},d:['ceylon.examples.photogallery','Page','$at','model']};});
        var view=PageView($$page);
        $$$cl1.defineAttr($$page,'view',function(){if (view===undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to read unitialized attribute «view»'));return view;},function(view$145){if(view!==undefined)throw $$$cl1.InitializationException($$$cl1.String('Attempt to reassign immutable attribute «view»'));return view=view$145;},function(){return{mod:$$METAMODEL$$,$t:{t:PageView},$cont:Page,$an:function(){return[$$$cl1.shared(),$$$cl1.late(),$$$cl1.shared(),$$$cl1.actual()];},d:['ceylon.examples.photogallery','Page','$at','view']};});
        $$page.model.parsePhotos(photos$142,dir$143);
        return $$page;
    }
    $$page.init=init;
    ...
    function display(photoNum$146){
        $$$cl1.print($$$cl1.String("display page: ",14).plus($$page.uri));
        $$page.view.display();
        $$$cl1.print($$$cl1.String("display photo: ",15).plus(photoNum$146.string));
        $$page.parent.displayPhoto($$page.model.photos.get(photoNum$146));
    }
...
function PageModel(controller, $$pageModel){
    ...
    $$$cl1.defineAttr($$pageModel,'photos',function(){return photos;},function(photos$147){return photos=photos$147;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Sequential,a:{Element:{t:Photo}}},$cont:PageModel,$an:function(){return[$$$cl1.shared(),$$$cl1.variable()];},d:['ceylon.examples.photogallery','PageModel','$at','photos']};});
    ...
    function parsePhotos(photosJSON$148,dir$149){
        $$$cl1.print($$$cl1.String("parsing photos",14));
        $$pageModel.photos=$$$cl1.Comprehension(function(){
            var it$150=photosJSON$148.iterator();
            var photo$151=$$$cl1.getFinished();
            var next$photo$151=function(){return photo$151=it$150.next();}
            next$photo$151();
            return function(){
                if(photo$151!==$$$cl1.getFinished()){
                    var photo$151$152=photo$151;
                    var tmpvar$153=Photo(photo$151$152.title,photo$151$152.caption,dir$149.plus($$$cl1.String("/",1)).plus(photo$151$152.src),dir$149.plus($$$cl1.String("/",1)).plus(photo$151$152.thumb),photo$151$152.height,photo$151$152.width,photo$151$152.alt);
                    next$photo$151();
                    return tmpvar$153;
                }
                return $$$cl1.getFinished();
...
function PageView(controller, $$pageView){
    ...
    var template$154;
    $$$cl1.defineAttr($$pageView,'template$154',function(){return template$154;},function(template$155){return template$154=template$155;},function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Anything},$cont:PageView,$an:function(){return[$$$cl1.variable()];},d:['ceylon.examples.photogallery','PageView','$at','template']};});
    $$pageView.$prop$getTemplate$154={$$metamodel$$:function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Anything},$cont:PageView,$an:function(){return[$$$cl1.variable()];},d:['ceylon.examples.photogallery','PageView','$at','template']};}};
    $$pageView.$prop$getTemplate$154.get=function(){return template$154};
    /*Begin dynamic block*/
    template$154=(typeof Handlebars==='undefined'||Handlebars===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: Handlebars")),'396:13-396:22','gallery.ceylon'):Handlebars).compile(/*NULL PARAM!*/$$$cjj3.jq($$$cl1.String("#page-template",14)).getHtml().$native);/*End dynamic block*/
    function display(){
        var photos$156=$$$cjj2.JSONArray();
        var it$157 = $$pageView.controller.model.photos.iterator();
        var photo$158;while ((photo$158=it$157.next())!==$$$cl1.getFinished()){
            photos$156.add((values$159=/*NULL PARAM!*/[$$$cl1.Entry($$$cl1.String("title",5),photo$158.title,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("uri",3),$$pageView.controller.uri,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("src",3),photo$158.thumb,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})/*NULL PARAM!*/,$$$cl1.Entry($$$cl1.String("alt",3),photo$158.alt,{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}})].reifyCeylonType({Absent:{t:$$$cl1.Null},Element:{t:$$$cl1.Entry,a:{Key:{t:$$$cl1.String},Item:{t:$$$cl1.String}}}}),$$$cjj2.JSON(values$159)));
            var values$159;
        }
        var context$160=(values$161=/*NULL PARAM!*/[$$$cl1.Entry($$$cl1.String("photos",6),photos$156,{Key:{t:$$$cl1.String},Item:{t:$$$cjj2.JSONArray}})].reifyCeylonType({Absent:{t:$$$cl1.Null},Element:{t:$$$cl1.Entry,a:{Key:{t:$$$cl1.String},Item:{t:$$$cjj2.JSONArray}}}}),$$$cjj2.JSON(values$161));
        var values$161;
        /*Begin dynamic block*/
        $$pageView.controller.parent.updatePage((tmpvar$162=template$154(/*NULL PARAM!*/context$160.toJson().$native),$$$cl1.isOfType(tmpvar$162,{t:$$$cl1.String})?tmpvar$162:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'413:32-413:64','gallery.ceylon')));
        /*End dynamic block*/
        var it$163 = (function(){var tmpvar$165=photos$156.size;
        if (tmpvar$165>0){
        var tmpvar$166=(0);
        var tmpvar$167=tmpvar$166;
        for (var i=1; i<tmpvar$165; i++){tmpvar$167=tmpvar$167.successor;}
        return $$$cl1.Range(tmpvar$166,tmpvar$167,{Element:{t:$$$cl1.Integer}})
        }else return $$$cl1.getEmpty();}()).iterator();
        var i$164;while ((i$164=it$163.next())!==$$$cl1.getFinished()){
            /*Begin dynamic block*/
            $$$cjj3.jq($$$cl1.String(".photo",6).plus(i$164.string)).hide();
            $$$cjj3.jq($$$cl1.String(".photo",6).plus(i$164.string)).on($$$cl1.String("load",4),null,null,$$$cl1.$JsCallable(function (event$168){
                return photoLoaded$169(i$164);
            },[{$nm:'event',$mt:'prm',$t:{t:$$$cl1.Anything},$an:function(){return[];}}],{Arguments:{t:$$$cl1.Tuple,a:{Rest:{t:$$$cl1.Empty},First:{t:$$$cl1.Anything},Element:{t:$$$cl1.Anything}}},Return:{t:$$$cl1.Anything}}));
            spin($$$cjj3.jq($$$cl1.String(".photo",6).plus(i$164.string)).parent()).spinPreset($$$cl1.String("small",5));
            /*End dynamic block*/
        }
    }
    ...
    function photoLoaded$169(photo$170){
        /*Begin dynamic block*/
        spin($$$cjj3.jq((tmpvar$171=(typeof this==='undefined'||this===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: this")),'426:11-426:14','gallery.ceylon'):this),$$$cl1.isOfType(tmpvar$171,{ t:'u', l:[{t:$$$cl1.String},{t:$$$cjj3.JQuery},{t:$$$cjl4.JSObject},{ t:'u', l:[{t:$$$cl1.Null},{t:$$$cjd172.Element}]}]})?tmpvar$171:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'426:11-426:14','gallery.ceylon'))).parent()).spinStop();
        $$$cjj3.jq((tmpvar$173=(typeof this==='undefined'||this===null?$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("Undefined or null reference: this")),'427:6-427:9','gallery.ceylon'):this),$$$cl1.isOfType(tmpvar$173,{ t:'u', l:[{t:$$$cl1.String},{t:$$$cjj3.JQuery},{t:$$$cjl4.JSObject},{ t:'u', l:[{t:$$$cl1.Null},{t:$$$cjd172.Element}]}]})?tmpvar$173:$$$cl1.throwexc($$$cl1.Exception($$$cl1.String("dynamic objects cannot be used here")),'427:6-427:9','gallery.ceylon'))).show();
        /*End dynamic block*/
    };photoLoaded$169.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Anything},$ps:[{$nm:'photo',$mt:'prm',$t:{t:$$$cl1.Integer},$an:function(){return[];}}],$cont:PageView,d:['ceylon.examples.photogallery','PageView','$m','photoLoaded']};};
    return $$pageView;
}
...
$init$PhotoJSON();
function spin(jq$174){
    /*Begin dynamic block*/
    return JQuerySpin(jq$174.$native);
    /*End dynamic block*/
}
exports.spin=spin;
...
$init$SpinDirection();
function clockwise$175(){
    var $$clockwise=new clockwise$175.$$;
    SpinDirection((1),$$clockwise);
    return $$clockwise;
}
function $init$clockwise$175(){
    if (clockwise$175.$$===undefined){
        $$$cl1.initTypeProto(clockwise$175,'ceylon.examples.photogallery::clockwise',$init$SpinDirection());
    }
    return clockwise$175;
}
exports.$init$clockwise$175=$init$clockwise$175;
$init$clockwise$175();
var clockwise$176;
function getClockwise(){
    if (clockwise$176===undefined)clockwise$176=$init$clockwise$175()();
    return clockwise$176;
}
exports.getClockwise=getClockwise;
getClockwise.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:clockwise$175},$an:function(){return[$$$cl1.shared()];},d:['ceylon.examples.photogallery','clockwise']};};
$prop$getClockwise={get:getClockwise,$$metamodel$$:getClockwise.$$metamodel$$};
exports.$prop$getClockwise=$prop$getClockwise;
function counterclockwise$177(){
    var $$counterclockwise=new counterclockwise$177.$$;
    SpinDirection((-(1)),$$counterclockwise);
    return $$counterclockwise;
}
function $init$counterclockwise$177(){
    if (counterclockwise$177.$$===undefined){
        $$$cl1.initTypeProto(counterclockwise$177,'ceylon.examples.photogallery::counterclockwise',$init$SpinDirection());
    }
    return counterclockwise$177;
}
exports.$init$counterclockwise$177=$init$counterclockwise$177;
$init$counterclockwise$177();
var counterclockwise$178;
function getCounterclockwise(){
    if (counterclockwise$178===undefined)counterclockwise$178=$init$counterclockwise$177()();
    return counterclockwise$178;
}
exports.getCounterclockwise=getCounterclockwise;
getCounterclockwise.$$metamodel$$=function(){return{mod:$$METAMODEL$$,$t:{t:counterclockwise$177},$an:function(){return[$$$cl1.shared()];},d:['ceylon.examples.photogallery','counterclockwise']};};
...
function SpinOptions(lines, length, width, radius, corners, direction, color, speed, trail, shadow, hardwareAccel, className, zIndex, top, left, $$spinOptions){
    ...
    function toJson(){
        var json$179=$$$cjl4.createJSObject();
        /*Begin dynamic block*/
        json$179.$native.lines=$$spinOptions.lines;
        json$179.$native.length=$$spinOptions.length;
        json$179.$native.width=$$spinOptions.width;
        json$179.$native.radius=$$spinOptions.radius;
        json$179.$native.corners=$$spinOptions.corners.valueOf();
        json$179.$native.direction=$$spinOptions.direction.direc;
        json$179.$native.color=$$spinOptions.color.valueOf();
        json$179.$native.speed=$$spinOptions.speed;
        json$179.$native.trail=$$spinOptions.trail;
        json$179.$native.shadow=$$spinOptions.shadow;
        json$179.$native.hwaccel=$$spinOptions.hardwareAccel;
        json$179.$native.zIndex=$$spinOptions.zIndex;
        json$179.$native.top=$$spinOptions.top;
        json$179.$native.left=$$spinOptions.left;
        return $$$cjj2.JSJSON(json$179.$native);
        /*End dynamic block*/
    }
...
function JQuerySpinAbs($$jQuerySpinAbs){
    ...
    $$jQuerySpinAbs.spin$defs$options=function(options$180){return null;};
    function spin(options$180){
        if(options$180===undefined){options$180=$$jQuerySpinAbs.spin$defs$options(options$180);}
        /*Begin dynamic block*/
        var o$181;
        if((o$181=options$180)!==null){
            $$jQuerySpinAbs.$native.spin(/*NULL PARAM!*/o$181.toJson());
        }else {
    ...
    $$jQuerySpinAbs.spinPreset$defs$color=function(name$182,color$183){return null;};
    function spinPreset(name$182,color$183){
        if(color$183===undefined){color$183=$$jQuerySpinAbs.spinPreset$defs$color(name$182,color$183);}
        /*Begin dynamic block*/
        $$jQuerySpinAbs.$native.spin(/*NULL PARAM!*/name$182.valueOf()/*NULL PARAM!*/,color$183);
        /*End dynamic block*/
    }
...
$init$JQuerySpinAbs();
function JQuerySpin(n$186, $$jQuerySpin){
    $init$JQuerySpin();
    if ($$jQuerySpin===undefined)$$jQuerySpin=new JQuerySpin.$$;
    $$jQuerySpin.n$186_=n$186;
    JQuerySpinAbs($$jQuerySpin);
    $$$cl1.defineAttr($$jQuerySpin,'n$186',function(){return this.n$186_;},undefined,function(){return{mod:$$METAMODEL$$,$t:{t:$$$cl1.Anything},$cont:JQuerySpin,d:['ceylon.examples.photogallery','JQuerySpin','$at','n']};});
    ...
    /*Begin dynamic block*/
    $$jQuerySpin.$native=n$186;/*End dynamic block*/
    return $$jQuerySpin;
}
